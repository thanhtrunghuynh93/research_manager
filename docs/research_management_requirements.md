...
Version 0.8 — proposed specification — 21 September 2026 (revised; see section 15)
...
A deployment holds one or more private research workspaces. **The two roles belong to them differently, and the asymmetry is the shape of the whole system:** a professor may belong to several workspaces at once, and a student belongs to exactly one. A professor reads across every workspace they belong to and writes into the one they are working in, switching between them; "working in one at a time" is a statement about where a write lands, not a limit on how many they may belong to. A student has one workspace, so for them the distinction does not arise.
